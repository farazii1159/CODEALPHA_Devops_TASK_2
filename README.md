...
![CodeAlpha Task 2 Specification](./Images/CodeAlpha-Task-2.png)
...
![Admin Setup](./Images/jenkins%20user.JPG)

### 2. Connected Nodes Dashboard (Connection Success)
...
![Nodes Status](./Images/jenkins%20ss2.JPG)

### 3. Successful Pipeline Console Execution
...
![Console Output](./Images/jenkins%20ss.JPG)
